#ifndef PASSGFW_NETWORK_CLIENT_IOS_H
#define PASSGFW_NETWORK_CLIENT_IOS_H
...
/**
 * iOS Platform Network Client Implementation
 * Using NSURLSession + Security.framework
 */
class NetworkClientIOS : public INetworkClient {
public:
    NetworkClientIOS();
    ~NetworkClientIOS() override;
...
private:
    void* public_key_;  // SecKeyRef
    int timeout_sec_;
};

} // namespace passgfw

#endif // PASSGFW_NETWORK_CLIENT_IOS_H
