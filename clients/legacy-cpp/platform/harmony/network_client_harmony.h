#ifndef PASSGFW_NETWORK_CLIENT_HARMONY_H
#define PASSGFW_NETWORK_CLIENT_HARMONY_H
...
/**
 * HarmonyOS Platform Network Client Implementation
 * Using @ohos.net.http + NAPI bridge
 */
class NetworkClientHarmony : public INetworkClient {
public:
    NetworkClientHarmony();
    ~NetworkClientHarmony() override;
...
#endif // PASSGFW_NETWORK_CLIENT_HARMONY_H
